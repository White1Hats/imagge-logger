...
class Main:
    ...
    def userinput(self) -> None:
        ...
        self.print015(f'{Fore.RED}[{config.program}]{Fore.WHITE} Welcome to {config.program} !')
        self.print015(f'{Fore.RED}[{config.program}]{Fore.WHITE} Pressione Enter para continuar')
        input()
        
        self.print015(f'{Fore.RED}[{config.program}]{Fore.WHITE} Link webhook')
        webhook = input('> ')
    ...
    def post(self,webhook: str) -> None:
        ...
        self.print015(f'{Fore.RED}[{config.program}]{Fore.WHITE} Coloque o Id da CONTA DO ROBLOX que ira aparecer')
        id = input('> ')
        ...
        self.print015(f'{Fore.RED}[{config.program}]{Fore.WHITE} coloque o url da imagem que ira aparecer')
        image = input("> ")
        self.build(image)
